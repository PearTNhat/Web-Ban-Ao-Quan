...
<body>
    <nav class="navbar navbar-expand-lg my-4 navbar-light">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#">HÀNG BÁN CHẠY</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="page-info bg-light">
        <div class="text-muted py-3 ms-4">
            <a href="#" class="text-decoration-none text-secondary">4MEN</a>
            <span> / </span>
            <a href="#" class="text-decoration-none text-secondary">Áo nam</a>
        </div>
    </div>