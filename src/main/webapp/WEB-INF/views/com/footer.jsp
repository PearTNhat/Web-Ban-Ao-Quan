  ...
  <footer class="px-4">
    <div class="row g-4 ">
      <div class="col-lg-3 col-sm-6 widget-footer">
        <img src="https://4menshop.com/logo-footer.png?v=1" alt="logo-footer">
      ...
      <div class="col-lg-3 col-sm-6 widget-footer">
        <h5 class="fw-bold text-white text-uppercase text-decoration-underline">Hỗ trợ khách hàng</h5>
        <ul class="list-footer">
      ...
      <div class="col-lg-3 col-sm-6 widget-footer ">
        <h5 class="fw-bold text-white text-uppercase text-decoration-underline">Kết nối với 4MEN</h5>
        <a href="#">
          <img class="w-100" loading="lazy" src="https://4menshop.com/images/footer-map.jpg" alt="map shop">
        </a>
      </div>
      <div class="col-lg-3 col-sm-6 widget-footer">
        <h5 class="fw-bold text-white text-uppercase text-decoration-underline">Hỗ trợ khách hàng</h5>
      ...
      <div class="col f-copyright">
        <p> Copyright 2024 · Thiết kế và phát triển bởi 4MEN SHOP All rights reserved
        </p>
      </div>
