...
<div class="page-info bg-light">
	<div class="container-xl text-muted py-3">
		<a href="#" class="text-decoration-none text-secondary">4MENS</a> <span>
			/ </span> <a href="#" class="text-decoration-none text-secondary">Áo nam</a>
	</div>
</div>
...
<div class="container-fuild">
	...
	<div id="owl-demo" class="owl-carousel owl-theme">
		<div class="item" style="width: 100%">
			<img
				src="resources/images/banners/banner-top-trang-chu-1-slide-19.jpg"
				alt="banner1">
		</div>
		<div class="item" style="width: 100%">
			<img
				src="resources/images/banners/banner-top-trang-chu-2-slide-20.jpg"
				alt="banner2">
		</div>
	</div>
</div>
