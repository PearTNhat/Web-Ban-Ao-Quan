...
<div class="main">
	  ...
	  <div class="container-fluid d-flex justify-content-between">
	    <div class="navbar-brand ms-4">
	      <div class="fs-5">
	      	...
	      	<a href="admin/accounts/admin-register.htm">Add user</a>
	      </div>
	    </div>
	    <div class="me-3">
	...
	<div class="container-xl">
		...
		<form:form action="admin/accounts/admin-register.htm" modelAttribute="user" enctype="multipart/form-data">
			<div class="lead mb-3 border-bottom pb-1 text-muted">Thông tin cá nhân</div>
			<div class="row mb-3">
				<form:label path="firstName" for="firstName" class="col-sm-2 col-form-label">* Họ</form:label>
			...
			<div class="row mb-3">
				<label path="lastName" for="lastName" class="col-sm-2 col-form-label">* Tên</label>
				<div class="col-sm-10 col-md-5">
			...
			<div class="row mb-3">
				<form:label path="address" for="address" class="col-sm-2 col-form-label">Địa chỉ</form:label>
				<div class="col-sm-10 col-md-5">
			...
			<div class="row mb-3">
				<form:label path="avatar" for="avatar" class="col-sm-2 col-form-label">Avatar</form:label>
				<div class="col-sm-10 col-md-5">
					<form:input path="avatar" type="file" class="form-control" id="avatar" />
				</div>
			...
			<div class="lead mb-3 border-bottom pb-1 text-muted">Thông tin đăng nhập</div>
			<div class="row mb-3">
			...
			<div class="row mb-3">
				<form:label path="password" for="password" class="col-sm-2 col-form-label">* Mật
					khẩu</form:label>
				<div class="col-sm-10 col-md-5">
			...
			<div class="row mb-3">
				<form:label path="confirmPassword" for="confirmPassword" class="col-sm-2 col-form-label">* Nhập lại mật
					 khẩu</form:label>
				<div class="col-sm-10 col-md-5">
